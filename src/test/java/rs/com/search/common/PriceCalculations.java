...
import static testUtils.StringUtil.getDoubleFromString;
...
//        return parseDouble(getDoubleFromString(findElementByXpath("//*[contains(@class,'orderValueCell grandTotalCell')]").
//                getText()));
